...
class IDQPlayView: UIView {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            exampleImageView.topAnchor.constraint(equalTo: topAnchor, constant: 0),
            exampleImageView.leftAnchor.constraint(equalTo: leftAnchor, constant: 0),
            exampleImageView.rightAnchor.constraint(equalTo: rightAnchor, constant: 0),
            exampleImageView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: 0),
        ])
